...
let users = [
    ...
    new User(3,'alia','el','asdgf@gmail.com','0632568975'),
    ...
    new User(7,'lef','hfdh','assadd@gmail.com','0632512575'),
    new User(8,'roma','prt','asjhjd@gmail.com','0632562565'),
    new User(9,'ivan','map2','afhsd@gmail.com','0632561255'),
    new User(10,'lenia','map10','asfhd@gmail.com','0632569975')
];

const filterArr = function(user){
    return user.id%2===0
}
